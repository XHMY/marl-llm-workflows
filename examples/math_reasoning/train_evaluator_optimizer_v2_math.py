"""Training entry point for the Evaluator-Optimizer V2 Math Workflow.

This script trains a 2-agent evaluator-optimizer V2 workflow for mathematical
problem solving using reinforcement learning with proper multi-turn conversation
structure.

Usage:
    python -m examples.math_reasoning.train_evaluator_optimizer_v2_math \
...
from examples.math_reasoning.evaluator_optimizer_v2_math_workflow import (
    EvaluatorOptimizerV2MathWorkflow,
)
...
def main(config):
    ...
    trainer = AgentTrainer(
        workflow_class=EvaluatorOptimizerV2MathWorkflow,
        workflow_args={
